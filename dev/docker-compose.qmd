...
* This step is optional: with no `chat.json` — or one that fails to parse — the container falls
  back to the generic `chat.sample.json` baked into the image, and the assistant still works. Check
