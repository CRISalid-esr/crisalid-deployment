...
* `CVS_API_PORT`: host port for the REST API. ⚠️ The default (`8000`) conflicts with the SVP Harvester
  default port — set a different value (e.g. `8005`) if both run on the same server.
