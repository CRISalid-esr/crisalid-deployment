...
- **Graph Database**  
  ...
  Access to Neo4j is **not direct**: it is mediated through:
    ...
    - [`crisalid-taxi`](https://github.com/CRISalid-esr/crisalid-taxi): An optional classification service that links
      documents to OpenAlex topics by semantic similarity, on behalf of `crisalid-ikg`.
